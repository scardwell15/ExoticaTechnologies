...
open class ChipSearcher<T : ModSpecialItemPlugin> {
    ...
    protected fun filterModChip(member: FleetMemberAPI, mods: ShipModifications, stack: CargoStackAPI, plugin: ModSpecialItemPlugin): Boolean {
        try {
    ...
    protected open fun filterChip(member: FleetMemberAPI, mods: ShipModifications, stack: CargoStackAPI, plugin: T): Boolean {
        return true
    }
     ...
     */
    protected fun getChipsFromCrate(member: FleetMemberAPI, plugin: CrateItemPlugin, mods: ShipModifications, mod: Modification): List<CargoStackAPI> {
