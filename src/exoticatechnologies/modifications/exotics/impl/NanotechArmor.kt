...
class NanotechArmor(key: String, settingsObj: JSONObject) :
    ...
    companion object {
        ...
        private var smokeController: NanoTechSmokeController? = null
    }
}

class NanoTechSmokeController : BaseCombatLayeredRenderingPlugin() {
    val SMOKE_RENDER_LAYER = EnumSet.of(CombatEngineLayers.CONTRAILS_LAYER)
    var SMOKES: MutableList<NanoTechSmoke> = mutableListOf()
    ...
    fun renderParticle(smoke: NanoTechSmoke) {
