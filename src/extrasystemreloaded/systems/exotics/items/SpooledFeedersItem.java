...
import extrasystemreloaded.systems.exotics.impl.SpooledFeeders;

public class SpooledFeedersItem extends ExoticSpecialItem {
    @Override
    public Exotic getExotic() {
        return ExoticsHandler.EXOTICS.get("SpooledFeeders");
    }
}
