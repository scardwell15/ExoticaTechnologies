...
import exoticatechnologies.dialog.*;
...
@Log4j
public class ETInteractionDialogPlugin extends BaseCommandPlugin implements InteractionDialogPlugin {
    ...
    public ShipModifications getExtraSystems() {
        return ShipModFactory.getForFleetMember(this.getShip());
    }
