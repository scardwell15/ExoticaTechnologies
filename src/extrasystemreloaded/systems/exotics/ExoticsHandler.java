...
import extrasystemreloaded.systems.exotics.dialog.ExoticsPickerState;
...
public class ExoticsHandler {
    ...
    public static List<String> getWhitelistForFaction(String faction) {
        List<String> factionAllowedExotics = MagicSettings.getList("extrasystemsreloaded", "rngExoticWhitelist");
        try {
            if(MagicSettings.modSettings.getJSONObject("extrasystemsreloaded").has(faction + "_ExoticWhitelist")) {
                factionAllowedExotics = MagicSettings.getList("extrasystemsreloaded", faction + "_ExoticWhitelist");
            }
