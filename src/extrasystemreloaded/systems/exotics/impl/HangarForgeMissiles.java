...
public class HangarForgeMissiles extends Exotic {
    public static final String EXOTIC_KEY = "HangarForgeMissiles";
    private static final String ITEM = "esr_hangarforge";
    private static final Color[] tooltipColors = {new Color(0xFF8902), ExtraSystemHM.infoColor, ExtraSystemHM.infoColor};
    ...
    public boolean canApply(FleetMemberAPI fm) {
        ...
        return canApply(fm.getVariant())
                ...
                && fm.getFleetData().getFleet().getCargo().getCredits().get() >= COST_CREDITS;
    }
